...
# Create iSEE object
ecm <- ExperimentColorMap(colData = list(celltype = celltype_colours), all_discrete = boolean_colours)
...
<!-- ```{r} -->
<!-- configureApp(appName = "LPMP_EHF_B_ATLAS", appDir = "shiny/integrated", size = "xlarge") -->
<!-- ``` -->

...
system("git add docs/figure/about.html")
system("git add docs/figure/index.html")
system("git add docs/figure/license.html")
system("git add docs/figure/01-quality-control.html")
system("git add docs/figure/02-normalization.html")
system("git add docs/figure/03-feature-selection.html")
system("git add docs/figure/04-reduced-dimensions.html")
system("git add docs/figure/05-clustering.html")
system("git add docs/figure/06-doublet-detection.html")
system("git add docs/figure/07-cell-cycle.html")
system("git add docs/figure/08-marker-detection.html")
system("git add docs/figure/09-cell-annotation.html")
system("git add docs/figure/10-atlas-integration.html")
system("git add docs/figure/lineage-markers.html")
